...
- Never add `Co-Authored-By`, "Generated with Claude Code", or any other AI attribution to commit messages, PR descriptions, or PR titles — not even when composing the message yourself.
